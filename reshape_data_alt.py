...
for row in lowReader:
	...
	whitePop = round(float(row[4]),-3)
	blackPop = round(float(row[5]),-3)
	nativePop = round(float(row[6]),-3)
	asianPop = round(float(row[7]),-3)
	latinxPop = round(float(row[8]),-3)
	age0Pop = round(float(row[9]),-3)
	age5Pop = round(float(row[10]),-3)
	age18Pop = round(float(row[11]),-3)
	age30Pop = round(float(row[12]),-3)
	age50Pop = round(float(row[13]),-3)
	totalPop = round(float(row[14]),-3)

	whiteNumber = round(-float(row[15]),-3)
	blackNumber = round(-float(row[16]),-3)
	nativeNumber = round(-float(row[17]),-3)
	asianNumber = round(-float(row[18]),-3)
	latinxNumber = round(-float(row[19]),-3)
	age0Number = round(-float(row[20]),-3)
	age5Number = round(-float(row[21]),-3)
	age18Number = round(-float(row[22]),-3)
	age30Number = round(-float(row[23]),-3)
	age50Number = round(-float(row[24]),-3)
	totalNumber = round(-float(row[25]),-3)
